        ...
        <v-form ref="form" v-model="valid">
          <v-row>
            ...
            <v-col cols="12" sm="12" md="12">
              <v-file-input :rules="rPhoto" filled accept="image/png, image/jpeg" show-size chips truncate-length=" 18">
              </v-file-input>
            </v-col>
            <v-col cols="12" sm="12" md="6">
            ...
            <v-col cols="12" sm="12" md="6">
              <v-btn :disabled="!valid" @click="validate" height="56px" x-large block color="primary">Crear</v-btn>
            </v-col>
          </v-row>
        </v-form>
      </v-card>
